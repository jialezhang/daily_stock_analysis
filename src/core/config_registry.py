...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        "category": "portfolio",
        "title": "Portfolio",
        "description": "Cross-market portfolio review settings and JSON inputs.",
        "display_order": 45,
    },
    {
        "category": "system",
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "PORTFOLIO_ENABLED": {
        "title": "Portfolio Review Enabled",
        "description": "Enable cross-market portfolio review after market review and through CLI.",
        "category": "portfolio",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "PORTFOLIO_INITIAL_CAPITAL": {
        ...
        "description": "Initial capital baseline in CNY for portfolio target tracking.",
        "category": "portfolio",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PORTFOLIO_TARGET_RETURN": {
        "title": "Portfolio Target Return",
        "description": "Target return ratio for portfolio review, such as 0.30 for 30%.",
        "category": "portfolio",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PORTFOLIO_HOLDINGS": {
        ...
        "description": "JSON payload for total asset, cash, holdings, and optional peak value.",
        "category": "portfolio",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "PORTFOLIO_STOCK_TAGS": {
        "title": "Portfolio Stock Tags JSON",
        "description": "JSON overrides for holding sector, style, and beta labels.",
        "category": "portfolio",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
